...
class ItemDetailScreen extends StatefulWidget {
  ...
  ItemDetailScreen({Key key, @required this.selectedItemData})
      : super(key: key);

  @override
  State<ItemDetailScreen> createState() =>
      ItemDetailState(objSelectedItemData: this.selectedItemData);
}
...
class ItemDetailState extends State<ItemDetailScreen>
        ...
        children: <Widget>[
          Container(
            ...
            child: FadeTransition(
              ...
              child: Column(
                ...
                children: [
                  Image.network(
                      "https://static4.depositphotos.com/1000441/322/i/600/depositphotos_3226927-stock-photo-eiffel-tower-in-paris.jpg"),
                ],
              ),
            ),
          ),
          Expanded(
            ...
            child: Row(
                ...
                children: <Widget>[
                  Text('${objSelectedItemData.distanceFromUserLocation}',
                      style: TextStyle(
                          fontSize: 100,
  ...
  Widget _loadBottomActionWidget() {
    if (objSelectedItemData.distanceFromUserLocation > 10) {
      return Text(
          'You have to be there around 1 km radius from the destination',
          style: TextStyle(
              fontSize: 18,
